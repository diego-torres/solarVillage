...
/**
 * <p>
 * Java class for permitResponse complex type.
 * 
 * <p>
...
@XmlType(name = "permitResponse", propOrder = { "requestId", "rejectReason", "ack" })
public class PermitResponse {
	 ...
	 * 
	 * @return possible object is {@link Ack }
	 * 
	 */
	public Ack getAck() {
		return ack;
	...
	public String toString() {
		return "PermitResponse [requestId=" + requestId + ", rejectReason=" + rejectReason + ", ack=" + ack + "]";
	}
}
