<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("associationMeeting");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid associationMeeting");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: HoaPermitOrder.HoaMeetingResults
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[sales]]></div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">associationMeeting</label>
                            		<div class="div_checkbox">
                              		${associationMeeting}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="associationMeeting" type="text" class="textbox" id="associationMeeting" value="${associationMeeting}" />
                            		</div>
