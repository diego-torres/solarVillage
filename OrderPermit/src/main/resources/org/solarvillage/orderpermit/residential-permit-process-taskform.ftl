<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("electricalContractNumber");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid electricalContractNumber");
							myInputs[j].focus();
							return false;
						}
					j++;
...
<div id="container">
	<div id="header">
		New Process Instance: /OrderPermit/src/main/resources/org/solarvillage/orderpermit.ResidentialPermitOrder
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<label for="name">electricalContractNumber</label>
                            		<div class="div_texbox">
                              		<input name="electricalContractNumber" type="text" class="textbox" id="electricalContractNumber" value="" />
                            		</div>
